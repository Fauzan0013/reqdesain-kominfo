                                    ...
                                    <div class="table-responsive">
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tbody style="background-color: white">
                                                <?php
                                                $no = 1;
                                                $data = $koneksi->query("SELECT * FROM berita ORDER BY id_berita DESC");
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td align="center"><b><?= $row['verifikasi'] ?></b></td>
                                                        <td align="center">
                                                            <a href="edit?id=<?= $row['id_berita'] ?>" class="btn btn-success btn-xs" title="Edit"><i class="fa fa-edit"></i> Edit</a>
                                                            <a href="hapus?id=<?= $row['id_berita'] ?>" class="btn btn-danger btn-xs alert-hapus" title="Hapus"><i class="fa fa-trash"></i> Hapus</a>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
