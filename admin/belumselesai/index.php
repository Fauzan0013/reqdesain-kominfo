        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Desain Belum Selesai</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Beranda</a></li>
                                <li class="breadcrumb-item active">Desain Belum Selesai</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                                            ...
                                            <tbody style="background-color: white">
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?= $row['status'] ?></td>
                                                        <td align="center">
                                                            <a href="edit?id=<?= $row['id_desain'] ?>" class="btn btn-success btn-xs" title="Edit"><i class="fa fa-edit"></i> Ubah Status/Masukkan Kendala</a>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
