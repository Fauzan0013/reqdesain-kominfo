...
<body class="hold-transition sidebar-mini layout-fixed">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                            <select class="form control select2" name="id_pegawai" id="id_pegawai" data-placeholder="Pilih" style="width: 100%;" readonly>
                                                    <option value=""></option>
                                                    <?php
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="form-control" data-placeholder="Pilih" name="jenis_desain" readonly>
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea type="text" class="form-control" name="deskripsi_desain" readonly><?= $row['deskripsi_desain'] ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Tanggal Permintaan</label>
                                            <div class="col-sm-9">
                                                <input type="date" class="form-control" name="tanggal_permintaan" value="<?= $row['tanggal_permintaan'] ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Kendala</label>
                                            <div class="col-sm-9">
                                                <textarea type="text" class="form-control" name="kendala"><?= $row['kendala'] ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                    ...
                                    <div class="card-footer" style="background-color: white;">
                                        <a href="<?= base_url('admin/belumselesai/') ?>" class="btn bg-gradient-secondary float-right"><i class="fa fa-arrow-left"> Batal</i></a>
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($submit) {
            ...
            echo "<script>window.location.replace('../belumselesai/');</script>";
        }
    }
