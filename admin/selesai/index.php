                                            ...
                                            <tbody style="background-color: white">
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td> <a href="<?= $row['url'] ?>" target="blank" class="btn btn-block btn-xs bg-yellow"><i class="fa fa-newspaper"></i> Download Desain</a></td>
                                                        <td><?= $row['status'] ?></td>
                                                        <td align="center">
                                                            <a href="edit?id=<?= $row['id_desain'] ?>" class="btn btn-success btn-xs" title="Edit"><i class="fa fa-edit"></i> Url Drive Desain</a>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
